"""
Configuration and argument parsing for unsupervised training.
"""
...
def parse_arguments():
    """Parse command line arguments for unsupervised training."""
    ...
    parser.add_argument('--temperature', type=float, default=None, help='Temperature for SCL loss')
